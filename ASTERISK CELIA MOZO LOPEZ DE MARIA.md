...
# <a name="_toc163067973"></a>**Índice**


[Índice	2](#_toc163067973)

[Introducción	3](#_toc163067974)

[IP Estática	4](#_toc163067975)

[Fuentes y dependencias	5](#_toc163067976)

[Instalación de Asterisk	5](#_toc163067977)

[Instalación del español como idioma en Asterisk	6](#_toc163067978)

[Instalación de Festival, conversor de texto a voz (TTS)	7](#_toc163067979)

[Voces en español para Festival	8](#_toc163067980)

[Integración de Festival en Asterisk	8](#_toc163067981)

[Instalación de MySQL	9](#_toc163067982)

[Creación de las tablas de nuestro centro de atención telefónica	10](#_toc163067983)

[Estableciendo la comunicación entre Asterisk y sistemas externos mediante conectores ODBC.	12](#_toc163067984)

[Interconexión con otra PBX utilizando el módulo DUNDi.	17](#_toc163067985)

[Creación de claves privadas y públicas	18](#_toc163067986)

[Funcionalidades de nuestra PBX	20](#_toc163067987)

[Buzón de Voz	20](#_toc163067988)

[Llamadas a grupo.	21](#_toc163067989)

[Mensajería de texto	22](#_toc163067990)

[Música Personalizada	22](#_toc163067991)

[Redireccionamiento con horario establecido	23](#_toc163067992)

[Menú de opciones para usuarios	23](#_toc163067993)

[Videollamada	23](#_toc163067994)

[Capturar llamadas	24](#_toc163067995)

[Conclusion	25](#_toc163067996)

[WEBGRAFIA	26](#_toc163067997)
...
# <a name="_toc163067974"></a>**Introducción**
...
# <a name="_toc163067975"></a>**IP Estática**
...
# <a name="_toc163067976"></a>**Fuentes y dependencias**
...
## <a name="_toc163067977"></a>Instalación de Asterisk
...
$ sudo ldconfig
## <a name="_toc163067978"></a>Instalación del español como idioma en Asterisk
...
sudo ./convertir
## <a name="_toc163067979"></a>Instalación de Festival, conversor de texto a voz (TTS)
...
### <a name="_toc163067980"></a>Voces en español para Festival
...
### <a name="_toc163067981"></a>Integración de Festival en Asterisk
...
## <a name="_toc163067982"></a>Instalación de MySQL
...
### <a name="_toc163067983"></a>Creación de las tablas de nuestro centro de atención telefónica
...
Descripción generada automáticamente](Aspose.Words.877262c2-3961-45af-81eb-d087ddba036d.003.png)

![Texto

Descripción generada automáticamente](Aspose.Words.877262c2-3961-45af-81eb-d087ddba036d.004.png)


## <a name="_toc163067984"></a>Estableciendo la comunicación entre Asterisk y sistemas externos mediante conectores ODBC.
...
![](Aspose.Words.877262c2-3961-45af-81eb-d087ddba036d.005.png)
...
Descripción generada automáticamente con confianza media](Aspose.Words.877262c2-3961-45af-81eb-d087ddba036d.006.png) ![Interfaz de usuario gráfica, Texto

Descripción generada automáticamente con confianza media](Aspose.Words.877262c2-3961-45af-81eb-d087ddba036d.007.png) ![Texto

Descripción generada automáticamente](Aspose.Words.877262c2-3961-45af-81eb-d087ddba036d.008.png) ![Texto

Descripción generada automáticamente con confianza media](Aspose.Words.877262c2-3961-45af-81eb-d087ddba036d.009.png)

![Captura de pantalla de computadora

Descripción generada automáticamente con confianza media](Aspose.Words.877262c2-3961-45af-81eb-d087ddba036d.010.png)
...
Descripción generada automáticamente](Aspose.Words.877262c2-3961-45af-81eb-d087ddba036d.011.png)
...
## <a name="_toc163067985"></a>Interconexión con otra PBX utilizando el módulo DUNDi.
...
### <a name="_toc163067986"></a>Creación de claves privadas y públicas
...
Descripción generada automáticamente](Aspose.Words.877262c2-3961-45af-81eb-d087ddba036d.012.png)
...
Descripción generada automáticamente](Aspose.Words.877262c2-3961-45af-81eb-d087ddba036d.013.png)

Y en la PBX 200 debemos tener

` `![Texto

Descripción generada automáticamente](Aspose.Words.877262c2-3961-45af-81eb-d087ddba036d.014.png)
...
# <a name="_toc163067987"></a>**Funcionalidades de nuestra PBX**
## <a name="_toc163067988"></a>Buzón de Voz
...
Descripción generada automáticamente](Aspose.Words.877262c2-3961-45af-81eb-d087ddba036d.015.png)
...
## <a name="_toc163067989"></a>Llamadas a grupo.
...
## <a name="_toc163067990"></a>Mensajería de texto
...
## <a name="_toc163067991"></a>Música Personalizada
...
## <a name="_toc163067992"></a>Redireccionamiento con horario establecido
...
## <a name="_toc163067993"></a>Menú de opciones para usuarios 
...
## <a name="_toc163067994"></a>Videollamada
...
Descripción generada automáticamente](Aspose.Words.877262c2-3961-45af-81eb-d087ddba036d.016.png)
## <a name="_toc163067995"></a>Capturar llamadas
...
Descripción generada automáticamente](Aspose.Words.877262c2-3961-45af-81eb-d087ddba036d.017.jpeg)

También podemos ver el archivo desde la CLI de Asterisk

![Texto

Descripción generada automáticamente](Aspose.Words.877262c2-3961-45af-81eb-d087ddba036d.018.jpeg)
...
# <a name="_toc163067997"></a>**Webgrafía**
...
Descripción generada automáticamente con confianza media](Aspose.Words.877262c2-3961-45af-81eb-d087ddba036d.019.jpeg)~ 29 ~
